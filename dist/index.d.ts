import { JSONDiff } from "danger/distribution/dsl/GitDSL";
...
export declare const getPnpmMetadataForDep: (dep: any) => Promise<string>;
 ...
 */
export default function pnpm(options?: Options): Promise<void>;
